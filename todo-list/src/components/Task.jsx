function Task( { id, tittle, group_name, description, timeframe } ) {
    return (
        <div className="task-container">
            ...
            <div className="task-actions-container">
                <label className="task-actions task-btn-checker">
                    <input type="checkbox" name="task-completed" />
                    <span className="checked checkbox-icon">
                ...
                <div className="task-actions task-btn-delete">
